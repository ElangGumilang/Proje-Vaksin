                ...
                <form action="koneksi.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            ...
                            <div class="form-group">
                        <label for="Program_jamninan">Program Jaminan</label>
                        <div class="form-check">
                            <input type="radio" class="form-check-input" name="Program_Jaminan" value="BPJS"> BPJS
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="Program_Jaminan" value="Non-BPJS"> Non-BPJS
                            </div>
                            <div class="form-group mt-3">
