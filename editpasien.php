                ...
                ?>
                    <form action="koneksi.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <label for="jk">Program Jaminan</label>
                            <div class="form-check">

                                <input type="radio" class="form-check-input" name="Program Jaminan" value="BPJS" <?php if (($row['jk']) === "BPJS") {
                                        echo "checked";
                                    } ?>> BPJS
                            </div>
                            ...
                            <div class="form-check">
                                ...
                                <input type="radio" class="form-check-input" name="Program_Jaminan" value="Non-BPJS" <?php if (($row['jk']) === "Non-BPJS") {
